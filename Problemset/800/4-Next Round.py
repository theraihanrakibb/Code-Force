...
The second line contains n space-separated integers a1,a2,...,an (0 ≤ ai ≤ 100), where is the
...
# Note: In the first example the participant on the 5th place earned 7 points. As the participant on the 6th place also
earned 7 points, there are 6 advances. In the second example nobody got a positive score.
"""
